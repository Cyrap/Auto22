<script lang="ts">
   ...
   $: visible = posts.slice(start, end).map((data: any, i: any) => {
   ...
   async function refresh(posts: any, viewport_height: any, postHeight: any) {
      ...
      let i = start;
      while (content_height < viewport_height && i < posts.length) {
      ...
      height_map.length = posts.length;
   ...
   async function handle_scroll() {
      ...
      while (i < posts.length) height_map[i++] = average_height;
      bottom = remaining * average_height;
