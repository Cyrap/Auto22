<script lang="ts">
   ...
   const handleClick = (e: MouseEvent) => {
     ...
     if (
       ...
       target.parentElement?.parentElement?.id.startsWith("$")
     ) {
       const selectedParkNumber = target.parentElement.id;
      ...
      <g id="Items">
         ...
         <g id="$773-941">
            ...
            <g id="773" opacity="0.8">
               <rect id="Rectangle" width="27.3317" height="55.5717" transform="matrix(0.853333 -0.521379 0.521143 0.853462 1700.49 1952.58)" fill="#3C4CDA" />
            </g>
         </g>
      </g>
      <g id="Extras">
